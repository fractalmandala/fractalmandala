<script lang="ts">
  ...
  import {
    ...
    devStore,
    showInitScreen,
  } from "$lib/prompta/stores/stores";
  import ThreadMenuList from "$lib/prompta/components/ThreadMenuList.svelte";
  import ThreadMenuButton from "$lib/prompta/components/ThreadMenuButton.svelte";
  import ChatMessageList from "$lib/prompta/components/ChatMessageList.svelte";
  import ActionsMenu from "$lib/prompta/components/ActionsMenu.svelte";
  import { getSystem } from "$lib/prompta/gui";
  import { dev } from "$app/environment";
  import IconTerminalPrompt from "$lib/prompta/components/IconTerminalPrompt.svelte";
  import classNames from "classnames";
  import IconSync from "$lib/prompta/components/IconSync.svelte";
  import CopyButton from "$lib/prompta/components/CopyButton.svelte";
  import { fly, slide } from "svelte/transition";
  import IconClose from "$lib/prompta/components/IconClose.svelte";
  import CloseButton from "$lib/prompta/components/CloseButton.svelte";
  import { isMobile } from "$lib/prompta/utils";
  import IconPlus from "$lib/prompta/components/IconPlus.svelte";
  import { mapKeysToMacSymbols } from "$lib/prompta/keyboard/shortcuts";
  import InitScreen from "$lib/prompta/components/InitScreen.svelte";
...
<div
  ...
  class="app-container"
>
  <header class="app-header p-4 pr-3 border-b border-zinc-700 w-full">
