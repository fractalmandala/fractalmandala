<script lang="ts">
	...
	import { themeSveltekit } from '$lib/utils/localpulls'
...
<div class="rta-grid grid2 stdfix" class:dark={$visibilityMode} class:light={!$visibilityMode}>
	...
	<div class="rta-column rightone" class:opened={expandRightbar}>
		...
		<p transition:slide={{ duration: 200, easing: circOut}}><strong><a href="/themes/webdev/sveltekit">SVELTEKIT HOME</a></strong></p>
