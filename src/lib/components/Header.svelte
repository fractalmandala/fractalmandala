			...
			<div class="leftballs">
				<div id="ibl">
						<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" style="transform: translateX({-y/12}px) rotate({y/2}deg); overflow: hidden">
							...
							<path id="fillerpath" fill-rule="evenodd" clip-rule="evenodd" d="M1.19249e-07 10C1.52179e-07 12.7615 1.11935 15.2615 2.9289 17.0711C4.73855 18.8807 7.23855 20 10 20C12.7614 20 15.2614 18.8807 17.0711 17.0711C18.8807 15.2615 20 12.7615 20 10C20 7.2386 18.8807 4.7386 17.0711 2.92894C15.2614 1.11929 12.7614 8.63194e-08 10 1.19249e-07C7.23855 1.52179e-07 4.73855 1.11929 2.9289 2.92894C1.11935 4.7386 8.63194e-08 7.2386 1.19249e-07 10Z" fill="#10D56C" style="transform-origin: center center; transform: scaleX({pagescrolled}) scaleY({pagescrolled})"/>
						</svg>
				</div>
				<div id="ibu">
