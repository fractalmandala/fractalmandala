<script lang="ts">
  ...
  import { PROMPT_OPTIONS } from '$lib/buildapp/sharedconstants';
  import { resizeTextarea } from '$lib/buildapp/sharedutils';
  import { banners$, savedPrompts$ } from '$lib/buildapp/stores';
  import {
    BANNER_TYPE,
    ERROR,
    LOCAL_STORAGE_KEY,
  ...
  export let updateSystemMessage:any;
  export let applyPrompt:any;
  ...
  const deletePrompt = (promptId:any) => {
  ...
  const selectPrompt = (pId:any, prompt:any) => {
    promptId = pId;
