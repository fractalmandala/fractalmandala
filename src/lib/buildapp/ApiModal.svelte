<script lang="ts">
  ...
  } from '$lib/buildapp/sharedconstants';
  import { banners$, gptModelVerified$, openAiApiKey$ } from '$lib/buildapp/stores';
  import { autofocus, chatCompletion } from '$lib/buildapp/sharedutils';
