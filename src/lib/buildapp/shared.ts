...
import { defaultOpenAiSettings, OpenAiModel, type OpenAiSettings } from '$lib/buildapp/openai';
import {
	modalStore,
	type ModalSettings,
	type ToastSettings,
	toastStore
} from '$lib/buildapp/skeleton';
import { generateSlug } from 'random-word-slugs';

import { goto } from '$app/navigation';
import { chatStore, settingsStore } from '$lib/buildapp/eventstores';
