...
import { defaultOpenAiSettings, OpenAiModel, type OpenAiSettings } from '$lib/slickbild/misc/openai';
import {
	modalStore,
	toastStore
} from '$lib/slickbild/helpers/stores';
import type {
	ModalSettings,
	ToastSettings,
} from '$lib/slickbild/types'
import { generateSlug } from 'random-word-slugs';

import { goto } from '$app/navigation';
import { chatStore, settingsStore } from '$lib/slickbild/misc/stores';

let PUBLIC_DISABLE_TRACKING = 'true'
