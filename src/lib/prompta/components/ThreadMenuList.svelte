<script lang="ts">
  import { currentThread, threadList, threadMenu } from "$lib/prompta/stores/stores";
  import classNames from "classnames";
  import { onMount, tick } from "svelte";
  import IconSparkle from "./IconSparkle.svelte";
  import { debounce, groupBy, isMobile } from "$lib/prompta/utils";
  import IconArchiveIn from "./IconArchiveIn.svelte";
  import { Fragment, type FragmentSearchResult } from "$lib/prompta/db";
  let _class: string = "";
