<script lang="ts">
  import { chooseRandomPrompts } from "$lib/prompta/llm/utils";
  import { currentChatThread, currentThread, isNewThread } from "$lib/prompta/stores/stores";
  import classNames from "classnames";
  import ChatMessageItem from "./ChatMessageItem.svelte";
  import IconBrainAiHybrid from "./IconBrainAiHybrid.svelte";
  import { onMount, afterUpdate, tick } from "svelte";
  import { debounce, throttle } from "$lib/prompta/utils";
